 ...
 *   - `bundle`          key/value — the cached campus graph/locations/
 *                        events/road-segments payload used for offline
 *                        navigation (see offlineBundle.js).
...
const DB_VERSION = 1
export const STORE_BUNDLE = 'bundle'
  ...
  dbPromise = new Promise((resolve, reject) => {
    ...
    req.onupgradeneeded = () => {
      ...
      if (!db.objectStoreNames.contains(STORE_BUNDLE)) {
        db.createObjectStore(STORE_BUNDLE)
      }
